...
def parse_args():
    ...
    parser.add_argument('--qid2title', type=str, required=True, help='Path for qid2title file')
    parser.add_argument('--alias2qids', type=str, required=True, help='Path for alias2qids file')
    parser.add_argument('--alias_cand_map_file', type=str, default='alias2qids.json', help='Name of file to write the alias2qids in the entity_dir')
    parser.add_argument('--entity_dir', type=str, required=True, help='Directory to write entity_db')
    parser.add_argument('--entity_map_dir', type=str, default='entity_mappings', help='Directory to write entity_mappings inside entity_dir')
    parser.add_argument('--max_candidates', type=int, default=30, help='Maximum number of candidates per alias')
...
def main():
    ...
    entity_mappings = EntitySymbols(max_candidates=args.max_candidates,
        max_alias_len=max_alias_len, alias2qids=alias2qids, qid2title=qid2title,
