...
def parse_args():
    ...
    parser.add_argument(
        "data_dir", default="../dataset/tacred", help="TACRED directory."
    )
    parser.add_argument(
        "vocab_dir", default="../dataset/vocab", help="Output vocab directory."
    )
    parser.add_argument(
        "--glove_dir", default="../dataset/glove", help="GloVe directory."
    )
    parser.add_argument(
