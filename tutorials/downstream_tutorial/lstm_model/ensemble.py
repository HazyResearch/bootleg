...
import numpy as np
from utils import constant, scorer


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument(
        "pred_files", nargs="+", help="A list of prediction files written by eval.py."
    )
    parser.add_argument("--data_dir", default="dataset/tacred")
    parser.add_argument(
        "--dataset", default="test", help="Evaluate on dev or test set."
    )
