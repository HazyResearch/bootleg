...
# word embeddings
parser.add_argument('--data_dir', type=str, default='dataset/tacred/', help='directory containing the tacred datasets')
parser.add_argument('--vocab_dir', type=str, default='dataset/vocab/', help='directory containing the word emb vocab')
...
# bootleg embeddings
parser.add_argument('--ent_vocab_dir', type=str, default='dataset/tacred/', help='directory containing the bootleg emb vocab (ent_embedding.npy and ent_vocab.pkl)')
